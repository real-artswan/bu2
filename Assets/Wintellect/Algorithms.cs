...
namespace Wintellect.PowerCollections
{
    ...
    public static class Algorithms
    {
        ...
        private class ReadOnlyCollection<T> : ICollection<T>
        {
            ...
            public IEnumerator<T> GetEnumerator() { return wrappedCollection.GetEnumerator(); }

            IEnumerator IEnumerable.GetEnumerator() { return ((IEnumerable)wrappedCollection).GetEnumerator(); }

            public bool Contains(T item) { return wrappedCollection.Contains(item); }
            ...
            public bool Remove(T item) { MethodModifiesCollection(); return false; }
        }
        ...
        private class ReadOnlyList<T> : IList<T>
        {
            ...
            public IEnumerator<T> GetEnumerator() { return wrappedList.GetEnumerator(); }

            IEnumerator IEnumerable.GetEnumerator() { return ((IEnumerable)wrappedList).GetEnumerator(); }

            public int IndexOf(T item) { return wrappedList.IndexOf(item); }

            public bool Contains(T item) { return wrappedList.Contains(item); }
        ...
        private class ReadOnlyDictionary<TKey, TValue> : IDictionary<TKey, TValue>
        {
            ...
            public bool ContainsKey(TKey key) { return wrappedDictionary.ContainsKey(key); }
            ...
            public bool TryGetValue(TKey key, out TValue value) { return wrappedDictionary.TryGetValue(key, out value); }
            ...
            public bool Contains(KeyValuePair<TKey, TValue> item) { return wrappedDictionary.Contains(item); }
            ...
            public IEnumerator<KeyValuePair<TKey, TValue>> GetEnumerator() { return wrappedDictionary.GetEnumerator(); }

            IEnumerator IEnumerable.GetEnumerator() { return ((IEnumerable)wrappedDictionary).GetEnumerator(); }
        }
        ...
        private class TypedCollection<T> : ICollection<T>
        {
            ...
            public IEnumerator<T> GetEnumerator() { return new TypedEnumerator<T>(wrappedCollection.GetEnumerator()); }

            IEnumerator IEnumerable.GetEnumerator() { return wrappedCollection.GetEnumerator(); }
        }
        ...
        private class TypedList<T> : IList<T>
        {
            ...
            public IEnumerator<T> GetEnumerator() { return new TypedEnumerator<T>(wrappedList.GetEnumerator()); }
        ...
        private class UntypedList<T> : IList
        {
            ...
            public IEnumerator GetEnumerator() { return ((IEnumerable)wrappedList).GetEnumerator(); }
        }
